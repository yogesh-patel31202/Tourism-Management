...
if (isset($_GET['id'])) {
  ...
  $destination_id = htmlspecialchars($_GET['id']);
}
  ...
  <main id="main">
    ...
    <div id="contact" class="contact-area">
      <div class="contact-inner area-padding">
        ...
        $dto = $service->getDestinationInfoById($destination_id);
        ?>
          ...
          <div class="row d-flex justify-content-center">
            ...
            <div class="col-md-6">
              <div class="form contact-form">
                <form action="src/Action/DestinationAction.php" method="post" enctype="multipart/form-data" role="form" class="form-control">
                  ...
                  <div class="d-flex justify-content-center">
											<img src="destination_img/<?php echo "des_".$dto->getId().".jpg"; ?>" id="preview-selected-image" onerror="this.src='assets/img/dummy.png'"
